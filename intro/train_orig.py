...
def plot_images(path, images, cls_true, cls_pred=None):
...
plot_images("samples.png", images=images, cls_true=cls_true)

# Helper to plot example errors

def plot_example_errors(path, cls_pred):
...
plot_example_errors("prediction-errors.png", cls_pred)
